...
# user = User.create(email: "creator@gmail.com", user_name: "creator123", admin: false, role: "Creator", password:"123456", password_confirmation:"123456",confirmed_at:Time.now.utc)

# user.user_roles.create(role: role3)